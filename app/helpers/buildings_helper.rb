module BuildingsHelper
  ...
  def automatic_fire_alarm_equipment
    ...
    # 消防法施行令第21条第1項第5号
      ...
      "#{@equipments[10]}が必要です（#{law(article: 21, paragraph: 1, item: 5, number: nil)}）"
    ...
    # 消防法施行令第21条第1項第9号イ
      ...
      "2項ニ,5項イ,6項イ(1)から(3),6項ロの部分には#{@equipments[10]}が必要です（#{law(article: 21, paragraph: 1, item: 9, number: "イ")}）"
    ...
    # 消防法施行令第21条第1項第11号
      ...
      "#{@equipments[10]}が必要です（#{law(article: 21, paragraph: 1, item: 11, number: nil)}）"
  ...
  def evacuation_tool
    ...
    if usege_in?(@building,[12, 13, 14, 15, 16, 17, 18, 19]) && ((@building.information_by_floors.where(floor_number: 2..Float::INFINITY, floor_capacity: 20..Float::INFINITY).present?) || (@building.information_by_basement_floors.where(floor_capacity: 20..Float::INFINITY).present?))
      "#{@equipments[15]}が必要です（#{law(article: 25, paragraph: 1, item: 1, number: nil)}）"
    ...
    # 消防法施行令第25条第1項第2号
      ...
      "#{@equipments[15]}が必要です（#{law(article: 25, paragraph: 1, item: 2, number: nil)}）"
    ...
    # 消防法施行令第25条第1項第3号(主要構造部の仕様については考慮せず)
      ...
      "#{@equipments[15]}が必要です（#{law(article: 25, paragraph: 1, item: 3, number: nil)}）"
    ...
    # 消防法施行令第25条第1項第4号
      ...
      "#{@equipments[15]}が必要です（#{law(article: 25, paragraph: 1, item: 4, number: nil)}）"
